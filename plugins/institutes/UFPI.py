...
def etl_courses():
    ...
    cursos_ufpi = mapper_cursos(dataframe=cursos_ufpi, instituicao='UFPI', resource_id='afb0de00-8f39-4f9c-9197-4364f7312a98', nome_curso='nome', id_curso='id_curso')
...
def etl_docentes():
    ...
    docentes_ufpi = mapper_docentes(dataframe=docentes_ufpi, instituicao='UFPI', resource_id='a34d7d7e-30af-41f0-81cf-cd10b6f078bd', nome_docente='nome', siape='siape', sexo='sexo', ano_ingresso='ano_ingresso', periodo_ingresso='periodo_ingresso', lotacao='lotacao')
...
def etl_discentes():
    ...
    discentes_ufpi = mapper_discentes(dataframe=discentes_ufpi, instituicao='UFPI', resource_id='00658685-cd1b-47f4-9f42-107c45a1e4e1', nome_discente='nome', matricula='matricula', sexo='sexo', ano_ingresso='ano_ingresso', periodo_ingresso='periodo_ingresso', nome_curso='curso')
